...
module serial_link_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[10] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_0_OFFSET);
    addr_hit[11] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_1_OFFSET);
    addr_hit[12] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_2_OFFSET);
    addr_hit[13] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_3_OFFSET);
    addr_hit[14] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_4_OFFSET);
    addr_hit[15] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_5_OFFSET);
    addr_hit[16] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_6_OFFSET);
    addr_hit[17] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_START_7_OFFSET);
    addr_hit[18] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_0_OFFSET);
    addr_hit[19] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_1_OFFSET);
    addr_hit[20] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_2_OFFSET);
    addr_hit[21] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_3_OFFSET);
    addr_hit[22] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_4_OFFSET);
    addr_hit[23] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_5_OFFSET);
    addr_hit[24] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_6_OFFSET);
    addr_hit[25] = (reg_addr == SERIAL_LINK_TX_PHY_CLK_END_7_OFFSET);
    addr_hit[26] = (reg_addr == SERIAL_LINK_RAW_MODE_EN_OFFSET);
    addr_hit[27] = (reg_addr == SERIAL_LINK_RAW_MODE_IN_CH_SEL_OFFSET);
    addr_hit[28] = (reg_addr == SERIAL_LINK_RAW_MODE_IN_DATA_VALID_OFFSET);
    addr_hit[29] = (reg_addr == SERIAL_LINK_RAW_MODE_IN_DATA_OFFSET);
    addr_hit[30] = (reg_addr == SERIAL_LINK_RAW_MODE_OUT_CH_MASK_OFFSET);
    addr_hit[31] = (reg_addr == SERIAL_LINK_RAW_MODE_OUT_DATA_FIFO_OFFSET);
    addr_hit[32] = (reg_addr == SERIAL_LINK_RAW_MODE_OUT_DATA_FIFO_CTRL_OFFSET);
    addr_hit[33] = (reg_addr == SERIAL_LINK_RAW_MODE_OUT_EN_OFFSET);
    addr_hit[34] = (reg_addr == SERIAL_LINK_FLOW_CONTROL_FIFO_CLEAR_OFFSET);
    addr_hit[35] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_TX_CFG_OFFSET);
    addr_hit[36] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_TX_CH_EN_OFFSET);
    addr_hit[37] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_TX_CTRL_OFFSET);
    addr_hit[38] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_RX_CFG_OFFSET);
    addr_hit[39] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_RX_CTRL_OFFSET);
    addr_hit[40] = (reg_addr == SERIAL_LINK_CHANNEL_ALLOC_RX_CH_EN_OFFSET);
  end
  ...
  assign tx_phy_clk_start_0_we = addr_hit[10] & reg_we & !reg_error;
  assign tx_phy_clk_start_0_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_1_we = addr_hit[11] & reg_we & !reg_error;
  assign tx_phy_clk_start_1_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_2_we = addr_hit[12] & reg_we & !reg_error;
  assign tx_phy_clk_start_2_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_3_we = addr_hit[13] & reg_we & !reg_error;
  assign tx_phy_clk_start_3_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_4_we = addr_hit[14] & reg_we & !reg_error;
  assign tx_phy_clk_start_4_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_5_we = addr_hit[15] & reg_we & !reg_error;
  assign tx_phy_clk_start_5_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_6_we = addr_hit[16] & reg_we & !reg_error;
  assign tx_phy_clk_start_6_wd = reg_wdata[10:0];

  assign tx_phy_clk_start_7_we = addr_hit[17] & reg_we & !reg_error;
  assign tx_phy_clk_start_7_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_0_we = addr_hit[18] & reg_we & !reg_error;
  assign tx_phy_clk_end_0_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_1_we = addr_hit[19] & reg_we & !reg_error;
  assign tx_phy_clk_end_1_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_2_we = addr_hit[20] & reg_we & !reg_error;
  assign tx_phy_clk_end_2_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_3_we = addr_hit[21] & reg_we & !reg_error;
  assign tx_phy_clk_end_3_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_4_we = addr_hit[22] & reg_we & !reg_error;
  assign tx_phy_clk_end_4_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_5_we = addr_hit[23] & reg_we & !reg_error;
  assign tx_phy_clk_end_5_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_6_we = addr_hit[24] & reg_we & !reg_error;
  assign tx_phy_clk_end_6_wd = reg_wdata[10:0];

  assign tx_phy_clk_end_7_we = addr_hit[25] & reg_we & !reg_error;
  assign tx_phy_clk_end_7_wd = reg_wdata[10:0];

  assign raw_mode_en_we = addr_hit[26] & reg_we & !reg_error;
  assign raw_mode_en_wd = reg_wdata[0];

  assign raw_mode_in_ch_sel_we = addr_hit[27] & reg_we & !reg_error;
  assign raw_mode_in_ch_sel_wd = reg_wdata[2:0];

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_0_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_1_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_2_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_3_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_4_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_5_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_6_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_valid_raw_mode_in_data_valid_7_re = addr_hit[28] & reg_re & !reg_error;

  assign raw_mode_in_data_re = addr_hit[29] & reg_re & !reg_error;

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_0_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_0_wd = reg_wdata[0];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_1_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_1_wd = reg_wdata[1];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_2_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_2_wd = reg_wdata[2];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_3_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_3_wd = reg_wdata[3];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_4_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_4_wd = reg_wdata[4];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_5_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_5_wd = reg_wdata[5];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_6_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_6_wd = reg_wdata[6];

  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_7_we = addr_hit[30] & reg_we & !reg_error;
  assign raw_mode_out_ch_mask_raw_mode_out_ch_mask_7_wd = reg_wdata[7];

  assign raw_mode_out_data_fifo_we = addr_hit[31] & reg_we & !reg_error;
  assign raw_mode_out_data_fifo_wd = reg_wdata[15:0];

  assign raw_mode_out_data_fifo_ctrl_clear_we = addr_hit[32] & reg_we & !reg_error;
  assign raw_mode_out_data_fifo_ctrl_clear_wd = reg_wdata[0];

  assign raw_mode_out_data_fifo_ctrl_fill_state_re = addr_hit[32] & reg_re & !reg_error;

  assign raw_mode_out_data_fifo_ctrl_is_full_re = addr_hit[32] & reg_re & !reg_error;

  assign raw_mode_out_en_we = addr_hit[33] & reg_we & !reg_error;
  assign raw_mode_out_en_wd = reg_wdata[0];

  assign flow_control_fifo_clear_we = addr_hit[34] & reg_we & !reg_error;
  assign flow_control_fifo_clear_wd = reg_wdata[0];

  assign channel_alloc_tx_cfg_bypass_en_we = addr_hit[35] & reg_we & !reg_error;
  assign channel_alloc_tx_cfg_bypass_en_wd = reg_wdata[0];

  assign channel_alloc_tx_cfg_auto_flush_en_we = addr_hit[35] & reg_we & !reg_error;
  assign channel_alloc_tx_cfg_auto_flush_en_wd = reg_wdata[1];

  assign channel_alloc_tx_cfg_auto_flush_count_we = addr_hit[35] & reg_we & !reg_error;
  assign channel_alloc_tx_cfg_auto_flush_count_wd = reg_wdata[15:8];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_0_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_0_wd = reg_wdata[0];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_1_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_1_wd = reg_wdata[1];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_2_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_2_wd = reg_wdata[2];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_3_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_3_wd = reg_wdata[3];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_4_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_4_wd = reg_wdata[4];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_5_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_5_wd = reg_wdata[5];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_6_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_6_wd = reg_wdata[6];

  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_7_we = addr_hit[36] & reg_we & !reg_error;
  assign channel_alloc_tx_ch_en_channel_alloc_tx_ch_en_7_wd = reg_wdata[7];

  assign channel_alloc_tx_ctrl_clear_we = addr_hit[37] & reg_we & !reg_error;
  assign channel_alloc_tx_ctrl_clear_wd = reg_wdata[0];

  assign channel_alloc_tx_ctrl_flush_we = addr_hit[37] & reg_we & !reg_error;
  assign channel_alloc_tx_ctrl_flush_wd = reg_wdata[1];

  assign channel_alloc_rx_cfg_bypass_en_we = addr_hit[38] & reg_we & !reg_error;
  assign channel_alloc_rx_cfg_bypass_en_wd = reg_wdata[0];

  assign channel_alloc_rx_cfg_auto_flush_en_we = addr_hit[38] & reg_we & !reg_error;
  assign channel_alloc_rx_cfg_auto_flush_en_wd = reg_wdata[1];

  assign channel_alloc_rx_cfg_auto_flush_count_we = addr_hit[38] & reg_we & !reg_error;
  assign channel_alloc_rx_cfg_auto_flush_count_wd = reg_wdata[15:8];

  assign channel_alloc_rx_cfg_sync_en_we = addr_hit[38] & reg_we & !reg_error;
  assign channel_alloc_rx_cfg_sync_en_wd = reg_wdata[16];

  assign channel_alloc_rx_ctrl_we = addr_hit[39] & reg_we & !reg_error;
  assign channel_alloc_rx_ctrl_wd = reg_wdata[0];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_0_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_0_wd = reg_wdata[0];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_1_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_1_wd = reg_wdata[1];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_2_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_2_wd = reg_wdata[2];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_3_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_3_wd = reg_wdata[3];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_4_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_4_wd = reg_wdata[4];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_5_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_5_wd = reg_wdata[5];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_6_we = addr_hit[40] & reg_we & !reg_error;
  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_6_wd = reg_wdata[6];

  assign channel_alloc_rx_ch_en_channel_alloc_rx_ch_en_7_we = addr_hit[40] & reg_we & !reg_error;
